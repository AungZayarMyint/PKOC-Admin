...
import { successToaster, errorToaster } from "../utils/Helper";
...
export default function CreatePost() {
  ...
  const handleFileChange = (e) => {
    ...
    setFilePreviews(filePreviewsArray); // Set the preview URLs
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await postMethod(CREATE_POST_API, formData);
      if (res?.isSuccess) {
